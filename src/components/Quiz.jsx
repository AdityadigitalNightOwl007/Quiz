    ...
    <>
        ...
        <div className="relative z-10 w-full max-w-3xl">
            <div 
            id="quiz-card"
            className="relative bg-gradient-to-br from-slate-900/80 via-indigo-950/70 to-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-500/30 p-10 md:p-14 overflow-hidden animate-fade-in"
            ...
            {/* Content */}
            <div className="relative z-10" key={currentQuestion}>
                {/* Icon and Question */}
                <div className="mb-10">
                <div className="flex items-start gap-5 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-light text-white leading-tight pt-2 animate-slide-in-right">
                ...
                {questions[currentQuestion].options.map((option, index) => (
                    ...
                    className={`w-full text-left px-7 py-4 rounded-2xl transition-all duration-300 flex items-center justify-between group animate-slide-in-left ${
                ...
                {/* Helper Text */}
                <p className="text-purple-300/50 text-sm mb-10 text-center font-light animate-fade-in-delay">
                Team adapts differently for each role; this helps route you to the right private pool.
                </p>

                {/* Bottom Section */}
                <div className="flex items-center justify-between animate-slide-up-bottom">
                {/* OK/Submit Button */}
                {currentQuestion === totalQuestions - 1 ? (
                    <button
                    onClick={handleSubmit}
                    disabled={!selectedAnswer}
                    className={`px-10 py-3.5 rounded-full font-medium transition-all flex items-center gap-2 text-base ${
                        selectedAnswer
                ...
                <div className="flex items-center gap-5">
                    ...
                    <span className="text-cyan-400 text-xl font-semibold transition-all duration-500">
                        {Math.round(progress)}%
                    </span>
                    <span className="text-purple-300/50 text-sm font-light">Complete</span>
                    </div>
